 ...
 *@module time
 *@group Components
 *@sig is_leap_year(year i64) -> bool
 ...
 *@module time
 *@group Formatting
 *@sig format(fmt string, timestamp i64) -> string
 ...
 *@module time
 *@group Formatting
 *@sig to_iso(timestamp i64) -> string
 ...
 *@module time
 *@group Formatting
 *@sig to_clock(timestamp i64) -> string
 ...
 *@module time
 *@group Parsing
 *@sig parse(s string, layout string) -> (i64, Error)
 ...
 *   import @time
 *   mut start i64 = time.now()
 *   mut elapsed i64 = time.since(start)
 *   println(elapsed)
 *@end
 */
 ...
 *@example
 *   import @time
 *   mut start i64 = time.tick()
 *   mut elapsed i64 = time.elapsed_ms(start)
 *   println(elapsed)
 *@end
 */
 ...
 *@module time
 *@group Performance
 *@sig elapsed_ms(start_tick i64) -> i64
 ...
 *@module time
 *@group Formatting
 *@sig humanize(seconds i64) -> string
 ...
 *@module time
 *@group Parsing
 *@sig parse_duration(s string) -> (i64, Error)
 ...
 *@module time
 *@group Formatting
 *@sig format_duration(seconds i64) -> string
 ...
 *@module time
 *@group Arithmetic
 *@sig add_days(timestamp i64, n i64) -> i64
 ...
 *@example
 *   import @time
 *   mut tomorrow i64 = time.add_days(time.now(), 1)
 *@end
 */
 ...
 *@module time
 *@group Arithmetic
 *@sig add_hours(timestamp i64, n i64) -> i64
 *@desc Returns timestamp shifted by n hours (n may be negative).
 *@example
 *   import @time
 *   mut later i64 = time.add_hours(time.now(), -2)
 *@end
 */
 ...
 *@module time
 *@group Arithmetic
 *@sig add_seconds(timestamp i64, n i64) -> i64
 *@desc Returns timestamp shifted by n seconds (n may be negative).
 *@example
 *   import @time
 *   mut soon i64 = time.add_seconds(time.now(), 30)
 *@end
 */
 ...
 *@module time
 *@group Arithmetic
 *@sig start_of_day(timestamp i64) -> i64
 *@desc Returns the Unix timestamp of 00:00:00 UTC on the same day as timestamp.
 *@example
 *   import @time
 *   mut midnight i64 = time.start_of_day(time.now())
 *@end
 */
 ...
 *@module time
 *@group Components
 *@sig days_in_month(year i64, month i64) -> i64
 ...
 *@module time
 *@group Components
 *@sig day_of_year(timestamp i64) -> i64
 ...
 *@module time
 *@group Components
 *@sig weekday_name(timestamp i64) -> string
 ...
 *@module time
 *@group Components
 *@sig month_name(timestamp i64) -> string
