 ...
 *@module binary
 *@group 64-bit
 *@sig encode_i64_be(val i64) -> [u8]
 *@desc Encodes a signed 64-bit integer as an 8-byte big-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_i64_be(-1000)
 *@end
 */
 ...
 *@module binary
 *@group 64-bit
 *@sig decode_i64_be(bytes [u8]) -> i64
 *@desc Decodes an 8-byte big-endian array as a signed 64-bit integer.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_i64_be(-1000)
 *   mut val i64 = binary.decode_i64_be(bytes)
 *@end
 */
 ...
 *@module binary
 *@group 128-bit
 *@sig encode_i128_le(val i128) -> [u8]
 *@desc Encodes a signed 128-bit integer as a 16-byte little-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_i128_le(i128(-1000))
 *@end
 */
 ...
 *@module binary
 *@group 128-bit
 *@sig decode_i128_le(bytes [u8]) -> i128
 ...
 *@module binary
 *@group 128-bit
 *@sig encode_i128_be(val i128) -> [u8]
 *@desc Encodes a signed 128-bit integer as a 16-byte big-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_i128_be(i128(-1000))
 *@end
 */
 ...
 *@module binary
 *@group 128-bit
 *@sig decode_i128_be(bytes [u8]) -> i128
 ...
 *@module binary
 *@group 128-bit
 *@sig encode_u128_le(val u128) -> [u8]
 *@desc Encodes an unsigned 128-bit integer as a 16-byte little-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_u128_le(u128(1000))
 *@end
 */
 ...
 *@module binary
 *@group 128-bit
 *@sig decode_u128_le(bytes [u8]) -> u128
 ...
 *@module binary
 *@group 128-bit
 *@sig encode_u128_be(val u128) -> [u8]
 *@desc Encodes an unsigned 128-bit integer as a 16-byte big-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_u128_be(u128(1000))
 *@end
 */
 ...
 *@module binary
 *@group 128-bit
 *@sig decode_u128_be(bytes [u8]) -> u128
 ...
 *@module binary
 *@group 256-bit
 *@sig encode_i256_le(val i256) -> [u8]
 *@desc Encodes a signed 256-bit integer as a 32-byte little-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_i256_le(i256(-1000))
 *@end
 */
 ...
 *@module binary
 *@group 256-bit
 *@sig decode_i256_le(bytes [u8]) -> i256
 ...
 *@module binary
 *@group 256-bit
 *@sig encode_i256_be(val i256) -> [u8]
 *@desc Encodes a signed 256-bit integer as a 32-byte big-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_i256_be(i256(-1000))
 *@end
 */
 ...
 *@module binary
 *@group 256-bit
 *@sig decode_i256_be(bytes [u8]) -> i256
 ...
 *@module binary
 *@group 256-bit
 *@sig encode_u256_le(val u256) -> [u8]
 *@desc Encodes an unsigned 256-bit integer as a 32-byte little-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_u256_le(u256(1000))
 *@end
 */
 ...
 *@module binary
 *@group 256-bit
 *@sig decode_u256_le(bytes [u8]) -> u256
 ...
 *@module binary
 *@group 256-bit
 *@sig encode_u256_be(val u256) -> [u8]
 *@desc Encodes an unsigned 256-bit integer as a 32-byte big-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_u256_be(u256(1000))
 *@end
 */
 ...
 *@module binary
 *@group 256-bit
 *@sig decode_u256_be(bytes [u8]) -> u256
 ...
 *@module binary
 *@group Floats
 *@sig encode_f64_le(val f64) -> [u8]
 *@desc Encodes an f64 as an 8-byte IEEE 754 little-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_f64_le(3.14)
 *@end
 */
 ...
 *@module binary
 *@group Floats
 *@sig decode_f64_le(bytes [u8]) -> f64
 *@desc Decodes an 8-byte IEEE 754 little-endian array as an f64.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_f64_le(3.14)
 *   mut val f64 = binary.decode_f64_le(bytes)
 *@end
 */
 ...
 *@module binary
 *@group Floats
 *@sig encode_f64_be(val f64) -> [u8]
 *@desc Encodes an f64 as an 8-byte IEEE 754 big-endian array.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_f64_be(3.14)
 *@end
 */
 ...
 *@module binary
 *@group Floats
 *@sig decode_f64_be(bytes [u8]) -> f64
 *@desc Decodes an 8-byte IEEE 754 big-endian array as an f64.
 *@example
 *   import @binary
 *   mut bytes [u8] = binary.encode_f64_be(3.14)
 *   mut val f64 = binary.decode_f64_be(bytes)
 *@end
 */
